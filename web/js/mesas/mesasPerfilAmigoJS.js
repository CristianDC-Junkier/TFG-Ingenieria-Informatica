...
Orden.addEventListener('change', function () {
    ...
    let urlDestinoOrden = "/TFG/Mesas/mostrarMesasAmigo?amigo=" + amigo + "&orden=" + valorSeleccionado + "&pag=" + pag;
...
if (pag > 2) {
    Binicio.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Mesas/mostrarMesasAmigo?amigo=" + amigo + "&orden=" + orden + "&pag=" + "1";
...
if (pagpordelante > 1) {
    Bfinal.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Mesas/mostrarMesasAmigo?amigo=" + amigo + "&orden=" + orden + "&pag=" + numpag;
        window.location.href = urlDestinoPag;
    });
}
//Pag anterior
if (pag > 1) {
    BAnterior.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Mesas/mostrarMesasAmigo?amigo=" + amigo + "&orden=" + orden + "&pag=" + (pag - 1);
        window.location.href = urlDestinoPag;
    });
}
//Pag posterior
