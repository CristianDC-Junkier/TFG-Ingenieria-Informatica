...
Orden.addEventListener('change', function () {
    ...
    let urlDestinoOrden = "/TFG/Mesas/mostrarMesasAmigo?mostrarMesasAmigo?amigo=" + amigo.id + "&orden=" + valorSeleccionado + "&pag=" + pag;
...
if (pag > 2) {
    Binicio.addEventListener('click', function () {
        ...
        urlDestinoPagIni = "/TFG/Mesas/mostrarMesasAmigo?amigo=" + amigo.id + "&orden=" + orden + "&pag=" + "1";
...
if (totalaux > 1) {
    Bfinal.addEventListener('click', function () {
        let urlDestinoPagIni;
        urlDestinoPagIni = "/TFG/Mesas/mostrarMesasAmigo?amigo=" + amigo.id + "&orden=" + orden + "&pag=" + numpag;
        window.location.href = urlDestinoPagIni;
    });
}
//Pag anterior
if (pag > 1) {
    BAnterior.addEventListener('click', function () {
        let urlDestinoPagIni;
        urlDestinoPagIni = "/TFG/Mesas/mostrarMesasAmigo?amigo=" + amigo.id + "&orden=" + orden + "&pag=" + (pag - 1);
        window.location.href = urlDestinoPagIni;
    });
}
//Pag posterior
