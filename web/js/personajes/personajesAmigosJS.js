...
Orden.addEventListener('change', function () {
    ...
    let urlDestinoOrden = "/TFG/Personajes/personajesAmigos?orden=" + valorSeleccionado + "&raza=" + Raza.value + "&clase=" + Clase.value + "&nivel=" + Nivel.value + "&pag=" + pag;
    window.location.href = urlDestinoOrden;
});

Raza.addEventListener('change', function () {
    let valorSeleccionado = Raza.value;
    let urlDestinoOrden = "/TFG/Personajes/personajesAmigos?orden=" + Orden.value + "&raza=" + valorSeleccionado + "&clase=" + Clase.value + "&nivel=" + Nivel.value + "&pag=" + pag;
    window.location.href = urlDestinoOrden;
});

Clase.addEventListener('change', function () {
    let valorSeleccionado = Clase.value;
    let urlDestinoOrden = "/TFG/Personajes/personajesAmigos?orden=" + Orden.value + "&raza=" + Raza.value + "&clase=" + valorSeleccionado + "&nivel=" + Nivel.value + "&pag=" + pag;
    window.location.href = urlDestinoOrden;
});

Nivel.addEventListener('change', function () {
    let valorSeleccionado = Nivel.value;
    let urlDestinoOrden = "/TFG/Personajes/personajesAmigos?orden=" + Orden.value + "&raza=" + Raza.value + "&clase=" + Clase.value + "&nivel=" + valorSeleccionado + "&pag=" + pag;
    window.location.href = urlDestinoOrden;
});
...
if (pag > 2) {
    Binicio.addEventListener('click', function () {
        ...
        urlDestinoOrden = "/TFG/Personajes/personajesAmigos?orden=" + Orden.value + "&raza=" + Raza.value + "&clase=" + Clase.value + "&nivel=" + Nivel.value + "&pag=" + "1";
...
if (totalaux > 1) {
    Bfinal.addEventListener('click', function () {
        let urlDestinoPagIni;
        urlDestinoOrden = "/TFG/Personajes/personajesAmigos?orden=" + Orden.valu + "&raza=" + Raza.value  + "&clase=" + Clase.value + "&nivel=" + raza + "&pag=" + numpag;
        window.location.href = urlDestinoPagIni;
    });
}
//Pag anterior
if (pag > 1) {
    BAnterior.addEventListener('click', function () {
        let urlDestinoPagIni;
        urlDestinoOrden = "/TFG/Personajes/personajesAmigos?orden=" + Orden.valu + "&raza=" + Raza.value  + "&clase=" + Clase.value + "&nivel=" + raza + "&pag=" + (pag - 1);
        window.location.href = urlDestinoPagIni;
    });
}
//Pag posterior
