...
Tipo.addEventListener('change', function () {
    ...
    let urlDestinoOrden = "/TFG/Personajes/personajeEquipoElegir?tipo=" + valorSeleccionado + "&categoria=" + Categoria.value + "&propiedad=" + Propiedad.value + "&pag=" + pag;
    window.location.href = urlDestinoOrden;
});
Categoria.addEventListener('change', function () {
    let valorSeleccionado = Categoria.value;
    let urlDestinoOrden = "/TFG/Personajes/personajeEquipoElegir?tipo=" + Tipo.value + "&categoria=" + valorSeleccionado + "&propiedad=" + Propiedad.value + "&pag=" + pag;
    window.location.href = urlDestinoOrden;
});
Propiedad.addEventListener('change', function () {
    let valorSeleccionado = Propiedad.value;
    let urlDestinoOrden = "/TFG/Personajes/personajeEquipoElegir?tipo=" + Tipo.value + "&categoria=" + Categoria.value + "&propiedad=" + valorSeleccionado + "&pag=" + pag;
    window.location.href = urlDestinoOrden;
});
...
if (pag > 2) {
    Binicio.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Personajes/personajeEquipoElegir?tipo=" + Tipo.value + "&categoria=" + Categoria.value + "&propiedad=" + Propiedad.value + "&pag=" + "1";
...
if (pagpordelante > 1) {
    Bfinal.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Personajes/personajeEquipoElegir?tipo=" + Tipo.value + "&categoria=" + Categoria.value + "&propiedad=" + Propiedad.value + "&pag=" + numpag;
        window.location.href = urlDestinoPag;
    });
}
//Pag anterior
if (pag > 1) {
    BAnterior.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Personajes/personajeEquipoElegir?tipo=" + Tipo.value + "&categoria=" + Categoria.value + "&propiedad=" + Propiedad.value + "&pag=" + (pag - 1);
        window.location.href = urlDestinoPag;
    });
}
//Pag posterior
