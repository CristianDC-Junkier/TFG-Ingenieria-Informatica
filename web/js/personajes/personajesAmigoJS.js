...
Orden.addEventListener('change', function () {
    ...
    urlDestinoPag = "/TFG/Personajes/personajesAmigo?amigo= "+ amigo.id + "?orden=" + valorSeleccionado + "&raza=" + Raza.value + "&clase=" + Clase.value + "&nivel=" + Nivel.value +"&pag=" + pag;
    window.location.href = urlDestinoPag;
});

Raza.addEventListener('change', function () {
    let valorSeleccionado = Raza.value;
    urlDestinoPag = "/TFG/Personajes/personajesAmigo?amigo= "+ amigo.id + "&orden=" + Orden.value + "&raza=" + valorSeleccionado + "&clase=" + Clase.value + "&nivel=" + Nivel.value + "&pag=" + pag;
    window.location.href = urlDestinoPag;
});

Clase.addEventListener('change', function () {
    let valorSeleccionado = Clase.value;
    urlDestinoPag = "/TFG/Personajes/personajesAmigo?amigo= "+ amigo.id + "&orden="+ Orden.value + "&raza=" + Raza.value + "&clase=" + valorSeleccionado + "&nivel=" + Nivel.value + "&pag=" + pag;
    window.location.href = urlDestinoPag;
});

Nivel.addEventListener('change', function () {
    let valorSeleccionado = Nivel.value;
    urlDestinoPag = "/TFG/Personajes/personajesAmigo?amigo= "+ amigo.id + "&orden=" + Orden.value + "&raza=" + Raza.value + "&clase=" + Clase.value + "&nivel=" + valorSeleccionado + "&pag=" + pag;
    window.location.href = urlDestinoPag;
});
...
if (pag > 2) {
    Binicio.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Personajes/personajesAmigo?amigo= "+ amigo.id + "&orden=" + Orden.value + "&raza=" + Raza.value + "&clase=" + Clase.value + "&nivel=" + Nivel.value + "&pag=" + "1";
        window.location.href = urlDestinoPag;
    });
}
//Pag Final
if (pagpordelante > 1) {
    Bfinal.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Personajes/personajesAmigo?amigo= "+ amigo.id + "&orden=" + Orden.valu + "&raza=" + Raza.value  + "&clase=" + Clase.value + "&nivel=" + Nivel.value + "&pag=" + numpag;
        window.location.href = urlDestinoPag;
    });
}
//Pag anterior
if (pag > 1) {
    BAnterior.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Personajes/personajesAmigo?amigo= "+ amigo.id + "&orden=" + Orden.valu + "&raza=" + Raza.value  + "&clase=" + Clase.value + "&nivel=" + Nivel.value + "&pag=" + (pag - 1);
        window.location.href = urlDestinoPag;
    });
}
//Pag posterior
