...
if (pag > 2) {
    Binicio.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Usuarios/mostrarUsuarios?orden=" + orden + "&mesa=" + mesa + "&pag=" + "1";
...
if (pagpordelante > 1) {
    Bfinal.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Usuarios/mostrarUsuarios?orden=" + orden + "&mesa=" + mesa + "&pag=" + numpag;
        window.location.href = urlDestinoPag;
    });
}
//Pag anterior
if (pag > 1) {
    BAnterior.addEventListener('click', function () {
        urlDestinoPag = "/TFG/Usuarios/mostrarUsuarios?orden=" + orden + "&mesa=" + mesa + "&pag=" + (pag - 1);
        window.location.href = urlDestinoPag;
    });
}
//Pag posterior
