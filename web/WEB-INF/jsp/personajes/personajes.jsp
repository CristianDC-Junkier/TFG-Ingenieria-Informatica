    ...
    <main>
        ...
        <div class="contenedoresPersonaje"> 
            <div class="contenedorPersonaje">
                <div class="tituloBuscadorPersonaje">Explorar Personajes</div>
                <div class="buscadorPersonaje">
                    <div>Busca por nombre: <input id="buscador" onkeyup="realizarBusqueda('Personajes')" type="search" placeholder="Introduce el nombre"/> </div>
                    <div>
                        Ordenar:
