...
<html>
    ...
    <body>
            ...
            <div class="contenedoresExplorar"> 
                <div class="contenedorExplorarListas">
                    ...
                    <form class="buscadorExplorar">
                        <input id="buscador" onkeyup="realizarBusqueda('personajeEquipo')" onsearch="realizarBusqueda('personajeEquipo')" type="search" placeholder="Busqueda por nombre">
                        ...
                        <button type="button" onclick="location.href = '/TFG/Personajes/personajeEquipoElegir?id=${requestScope.id}'">Añadir más</button> 
        ...
        <script src="/TFG/js/personajes/personajeEquipoJS.js"></script>
