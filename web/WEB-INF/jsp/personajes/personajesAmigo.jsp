        ...
        <div class="contenedoresPersonaje"> 
            <div class="contenedorPersonaje">
                ...
                <div class="buscadorPersonaje">
                    <div>Busca por nombre: <input id="buscador" onkeyup="realizarBusqueda('PersonajesAmigo')" type="search" placeholder="Introduce el nombre"/>  </div>
                    <div>
                        Ordenar:
                                ...
                                <table>
                                    <c:forEach var="personaje" items="${listaPersonajes}" varStatus="status">
                                        <tr>
                                            ...
                                            <td><button class="botonDentro" onclick="location.href = '/TFG/Personaje/personajeAmigo?id=${personaje.id}&amigo=${requestScope.amigo.id}'">Detalles</button></td>
                                        </tr>
                                    </c:forEach>
                                </table>
                            </div>
