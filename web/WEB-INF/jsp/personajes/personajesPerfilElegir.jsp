...
<body>
        ...
        <div class="contenedoresPersonaje"> 
            <div class="contenedorPersonaje">
                ...
                <div class="buscadorPersonaje">
                    <div>Busca por nombre: <input id="buscador" onkeyup="realizarBusqueda('PersonajesPerfilElegir')" type="search" placeholder="Introduce el nombre"/>  </div>
                    <div>
                        Ordenar:
                    ...
                    <button class="botonDentro" onclick="location.href = '/TFG/Usuarios/perfil'">Volver</button>
                </div>
            </div>
                                ...
                                <table>
                                    <c:forEach var="personaje" items="${listaPersonajes}" varStatus="status">
                                        <tr>
                                            ...
                                            <td><button class="botonDentro" onclick="location.href = '/TFG/Usuarios/personajeActual?id=${personaje.id}'">Elegir</button></td>
                                        </tr>
                                    </c:forEach>
                                </table>
                            </div>
    ...
    <script src="/TFG/js/personajes/personajesPerfilElegirJS.js"></script>
</body>
</html>