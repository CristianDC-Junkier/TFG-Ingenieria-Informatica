...
<html>
    ...
    <body>
            ...
            <div class="contenedoresExplorar"> 
                <div class="contenedorExplorarListas">
                    ...
                    <form class="buscadorExplorar">
                        <input  id="buscador" onkeyup="realizarBusqueda('personajeHechizos')" onsearch="realizarBusqueda('personajeHechizos')" type="search" placeholder="Busqueda por nombre">
                        ...
                        <button type="button" onclick="location.href = '/TFG/Personajes/personajeHechizosElegir?id=${requestScope.id}'">Añadir más</button> 
                        <button type="button" onclick="location.href = '/TFG/Personajes/personajePerfil?id=${requestScope.id}'">Volver</button>
                    </form>
                </div>
                                            ...
                                            <c:choose>
                                                <c:when test="${hechizo != null}">
                                                    <tr>
                                                        ...
                                                        <td><button class="botonDentro" onclick="location.href = '/TFG/Personajes/personajeHechizoEliminar?hechizo=${hechizo.id}&personaje=${requestScope.id}'">Eliminar</button></td>
                                                    </tr>
                                                    <tr class="tablaHechizosTR">
        ...
        <script src="/TFG/js/personajes/personajeHechizosJS.js"></script>
