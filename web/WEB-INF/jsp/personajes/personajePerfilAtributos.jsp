...
<html>
    <head>
        <title class="titulosPag">Guidance4\Personajes\Mi_Personaje\Atributos</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <main>
            ...
            <div>
                ...
                <button class="botonAtrasPJ" onclick="location.href = '/TFG/Formularios/modificarPersonajeAtributos?id=${requestScope.personaje.id}'">Modificar</button>
            </div>
