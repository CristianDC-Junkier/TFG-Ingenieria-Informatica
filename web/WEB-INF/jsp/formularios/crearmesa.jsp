                    ...
                    <c:choose>
                        <c:when test="${requestScope.mesasTotales != 5}">
                            ...
                            <div class="contenedorBotonFormulario">
                                <input id="botonVolverFormulario" type="button" onclick="location.pathname = 'TFG/Mesas/mostrarMesasUsuario'" value="Volver">
                        ...
                        <c:otherwise>
                            ...
                            <div class="contenedorBotonFormulario">
                                <input id="botonVolverFormulario-Solo" type="button" onclick="location.pathname = 'TFG/Mesas/mostrarMesasUsuario'" value="Volver">
                            </div>
                        </c:otherwise>
                    </c:choose>
                </form>
